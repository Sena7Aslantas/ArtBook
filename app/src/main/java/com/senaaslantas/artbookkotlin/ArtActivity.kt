package com.senaaslantas.artbookkotlin
...
import com.senaaslantas.artbookkotlin.databinding.ActivityArtBinding
...
class ArtActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(info.equals("new")){
           ...
           // binding.button.visibility=View.VISIBLE
            ...
            val selectedİd=intent.getIntExtra("id",1)
            val cursor = Database.rawQuery("SELECT * FROM arts WHERE id = ?", arrayOf(selectedİd.toString()))
    ...
    fun saveButton(view: View) {
        ...
        if (selectedBitmap != null) {
            val smallBitmap = makeSmallerBitmep(selectedBitmap!!, 300)
    ...
    private fun makeSmallerBitmep(image:Bitmap,maximumSize:Int):Bitmap{
